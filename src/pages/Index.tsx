...
const Index = () => {
  ...
  return <div className="min-h-screen hero-gradient flex flex-col">
      {/* Navigation */}
      <nav className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            <h1 className="font-semibold text-xl text-foreground" style={{
        ...
        <div className="flex items-center justify-center gap-6 md:gap-10 mt-4 text-sm">
          ...
          <button onClick={() => setAboutOpen(true)} className="text-muted-foreground hover:text-foreground transition-colors">
            About
          </button>
          <button onClick={() => setFeedbackOpen(true)} className="text-muted-foreground hover:text-foreground transition-colors">
            Send Feedback
          </button>
        </div>
      </nav>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24 flex-1">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 animate-slide-up" style={{
          animationDelay: "0.1s"
        }}>
      ...
      <section id="features" className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          }].map((feature, index) => <div key={index} className="feature-card animate-slide-up" style={{
